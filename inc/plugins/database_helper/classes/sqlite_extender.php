...
class sqlite_extender extends DB_SQLite
{
    /**
    ...
    /**
     * sqlite_extender constructor. We need to do a few things to make this work.
     */
    ...
    {
        // Can't add a foreign key to existing tables.
        return false;
    }
    ...
    {
        // Returning false is better here since the add_foreign_key function returns false.
        return false;
    }
    ...
    public function truncate_table($table)
    {
        ...
        $this->delete_rows = 1;
        $this->write_query("DELETE FROM " . $this->table_prefix . $table);
     ...
     */
    public function fetch_clean_array($resource, $resulttype =PDO::FETCH_BOTH)
    {
