...
class pgsql_extender extends DB_PgSQL
{
    /**
    ...
    /**
     * pgsql_extender constructor. We need to do a few things to make this work.
     */
     ...
     */
    public function fetch_clean_array($resource, $resulttype = PGSQL_ASSOC)
    {
