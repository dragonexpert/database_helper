...
class mysqli_extender extends DB_MySQLi
{
    /**
    ...
    /**
     * mysqli_extender constructor. We need to do a few things to make this work.
     */
     ...
     */
    public function fetch_clean_array($resource, $resulttype = MYSQLI_ASSOC)
    {
